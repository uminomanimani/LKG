...
def filter_tag(input_string): # reserve the first <e> </e> and delete the rest
...
def clause_clean(description): # remove clause if possible
...
if __name__ == "__main__":
    ...
    for count, item in enumerate(request_data):
        ...
        for entity in entities:
            entity["mentions"] = list(map(str, entity["mentions"]))
        
        all_mentions = []
        
        for entity in entities:
            all_mentions.append(entity["mentions"])
